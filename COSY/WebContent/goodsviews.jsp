...
<html>
	...
	<body>
        ...
        <div class="two-code">
			...
			<div id="proview">
				<img src="upload/<%=objbyid.get("imgurl")%>" style="width: 250px; height: 300px;"/>
				<div id="proviewdescription">
					<div class="briefdiv">
						<p class="p1" style="font-size:20px">
							<span><%=objbyid.get("shopname")%></span>
							
						</p>
						
						<p style="width: 700px; height: 100px; background-color:lightgrey; font-size:16px">
							&nbsp; &nbsp; &nbsp; &nbsp;<%=objbyid.get("information") %>
						</p>
						<p style="color: lightslategray; font-size: 15px; margin:10px 0;"> <del>原价：<%=objbyid.get("useprice") %></del></p>
						<p class="price"> 价格：<%=objbyid.get("newprice") %>&nbsp;&nbsp;&nbsp; <span class="p1" style="color: brown">产地：<%=objbyid.get("adress") %></span></p>
					...
					<div style="width: 750px; height: 100px; border: solid 1px white; position: relative;">
						...
						<a href="javascript:;" class="btnaddtocar btnCart" data-proid=<%=objbyid.get("id") %> id="btnaddtocar">加入购物车</a>
						<button class="btnaddtocar" data-proid=<%=objbyid.get("id") %> id="btnaddtocar2" style="position: absolute; top: 0.5%; left: 50%;">立即购买</button>
					</div>
		...
		<script type="text/javascript">
			...
			$(function(){
				...
				$.ajax({
					...
					success: function(data) {
						console.log(data);
						$("span.cart_num").text(data.procount);
						$(data.prolist).each(function(index,item){
							//console.log(index,item);
							console.log($("#carprolist").length);
							$("#carprolist").html('<li class="cart_item">111<div class="cart_item_pic"><a href="#"><img src="upload/'+item.imgurl+'" /></a></div><div class="cart_item_desc"><a href="#" class="cart_item_name">夏季透气真皮豆豆鞋反绒男士休闲鞋韩版磨砂驾车鞋英伦船鞋男鞋子</a><div class="cart_item_sku"><span>尺码：38码（精工限量版）</span></div><div class="cart_item_price"><span class="cart_price">￥700.00</span></div></div>	</li>');
						});
