 			...
 			<div class="product-box">
                <div class="inner-info">
                    <div>
                        ...
                        <span class="text-title"><%=m.get("typeid")%></span>
                    ...
                    <div class="inner-left">
                        <img src="upload/<%=m.get("imgurl")%>" style="width: 168px; height: 190px;"/>
                    </div>
                    <div class="inner-right">
                        <div>
                            <a href="#"><%=m.get("shopname")%></a>
                        </div>
                        <div class="tab-inner" style="position: relative;">
                        	<div style="width:100px; height:30px; background-color:orangered; position: absolute; left:20%; top:-50%;line-height:30px;"><a href="uigoodsviews?id=<%=m.get("id")%>" style="color:white;">购买</a></div>
                            <p>￥<del><%=m.get("useprice")%></del></p>                                                   
                            <p>￥<em><%=m.get("newprice")%></em></p>
                            <p><%=m.get("adress")%>&nbsp;&nbsp;&nbsp;&nbsp;销量：<%=m.get("counts")%></p>
                        </div>
                    </div>
                </div>
            </div>
