...
/**
 * Servlet implementation class uigoodsview
 */
@WebServlet("/uigoodsview")
public class uigoodsview extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// TODO Auto-generated method stub
		 ...
		 String strSql=" select * from tbgoodsadd where id=? "; 
		 ...
		 request.getRequestDispatcher("/goodsviews.jsp").forward(request, response);
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String sessionid=request.getSession().getId();//生成本次访问唯一用户序列号
		Boolean flag=false;
		...
		else
		{
			//根据id把商品信息查询出来。
			List<Object> params = new ArrayList<Object>();
			String StrSqlpro="select * from tbgoodsadd where id="+id;
			...
			params.add(obj.get("shopname"));
			params.add(id);
			params.add(1);
			params.add(createtime);
			params.add(obj.get("imgurl"));
			params.add(obj.get("newprice"));
